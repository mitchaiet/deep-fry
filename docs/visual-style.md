...
- **Image settings have their own language.** Labeled View and Palette dropdowns use square paper fields and arrows. View chooses Output (what you hear) or JPEG only (before mix); Palette chooses Colour or Grayscale. The footer reads "VIEW + PALETTE: IMAGE ONLY" in high-contrast text. PNG export and Freeze sit beside the menus; L / R selects the channel beside INPUT.
